...
// Shared accent colors for this template.
const ACCENT_GREEN = "#178a4f"; // verify / success action
const ACCENT_LINK = "#4f46e5"; // indigo, used for text links
...
export const emailVerificationTemplate = (
    ...
    const displayEmail = domainPart
        ? `${escapeHtml(localPart)}@&#8203;${escapeHtml(domainPart).replace(
            /\.([^.]+)$/,
            "&#8203;.$1",
        )}`
